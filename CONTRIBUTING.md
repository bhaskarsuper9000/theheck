...
the following basic information:
  - the output of `theheck --version` (something like `The Fuck 3.1 using
    Python 3.5.0`);
  - your shell and its version (`bash`, `zsh`, *Windows PowerShell*, etc.);
  - your system (Debian 7, ArchLinux, Windows, etc.);
  - how to reproduce the bug;
  - the output of The Fuck with `THEHELL_DEBUG=true` exported (typically execute
    `export THEHELL_DEBUG=true` in your shell before The Fuck);
